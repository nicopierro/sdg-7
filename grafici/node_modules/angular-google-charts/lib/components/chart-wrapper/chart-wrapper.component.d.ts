...
export declare class ChartWrapperComponent implements ChartBase, OnChanges, OnInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ChartWrapperComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ChartWrapperComponent, "chart-wrapper", ["chartWrapper"], { "specs": "specs"; }, { "error": "error"; "ready": "ready"; "select": "select"; }, never, never>;
}
